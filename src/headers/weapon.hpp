...
Weapon* greatsword(int amount = 1);
Weapon* flail(int amount = 1);
Weapon* javelin(int amount = 1);
Weapon* scimitar(int amount = 1);
Weapon* shortsword(int amount = 1);
Weapon* longbow(int amount = 1);
